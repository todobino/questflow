...
>(({ className, ...props }, ref) => {
  return (
    <Separator
      ...
      className={cn("bg-sidebar-border", className)} // Removed mx-2 and w-auto
      {...props}
    />
  )
})
